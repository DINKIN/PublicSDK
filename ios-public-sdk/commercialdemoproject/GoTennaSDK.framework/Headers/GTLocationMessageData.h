...
- (id)initWithLocationType:(NSNumber *)number andLatitude:(NSNumber *)latitude andLongitude:(NSNumber *)longitude andGPSTimestamp:(NSTimeInterval)gpsTimestamp andName:(NSString *)name onError:(NSError **)error;
